...
public class CountryOfficeControllerTest {
	...
	public void shouldReturnAllCountries() throws Exception {
		...
		List<CountryDto> listOfCountryDto = new ArrayList<CountryDto>();
	...
	public void shouldReturnAllOfficesBasedOnCountryId() throws Exception {
		...
		mvc.perform(get("/countries/7000/offices").contentType(MediaType.APPLICATION_JSON))
			.andExpect(status().isOk())
	...
	public CountryDto createCountryDto()
	{
		...
		countryDto.setCountryId(new Long(7000));
