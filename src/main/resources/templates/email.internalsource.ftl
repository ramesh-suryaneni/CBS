...
<body>
<div class="div1" >
<center><p style="font-size:20px;">Internal Resource Notification</p></div></center>
<div class="div2">
<div class="boxed">
<h1 style="font-size: 10px;"><center>Summary</center></h1>
...
<tr><th>
<td><img style="height:15px;width:15px"src="https://img.icons8.com/wired/64/000000/edit-property.png"/> ${jobNumber} - ${jobName}</td>
</th></tr>
<tr><th>
