...
public interface BookingRevisionRepository extends JpaRepository<BookingRevision, Long> {
	...
	public static final String BOOKING_REVISIONQU_DETAILS_QUERY = "SELECT asd.approval_name as status, br.booking_id as bookingId, br.job_name as jobName, rd.role_name as roleName, "
