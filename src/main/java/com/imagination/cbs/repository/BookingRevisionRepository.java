...
public interface BookingRevisionRepository extends JpaRepository<BookingRevision, Long> {
	...
	public static final String BOOKING_REVISIONQU_DETAILS_QUERY = "SELECT asd.approval_name as status, br.booking_id as bookingId, br.job_name as jobName, rd.role_name as role, br.contractor_name as contractor,"
	...
	@Query(value = "SELECT asd.approval_name as status, br.booking_id as bookingId, br.job_name as jobName, rd.role_name as role, br.contractor_name as contractor,"
			+" br.contracted_from_date as startDate, br.contracted_to_date as endDate, br.changed_by as changedBy, br.changed_date as changedDate" 
	...
	@Query(value = "SELECT asd.approval_name as status, br.booking_id as bookingId, br.job_name as jobName, rd.role_name as role, br.contractor_name as contractor,"
			...
			+" where br.team_id in(select team_id from cbs.approver where employe_id=1034 and approver_order in (1,2,3))", nativeQuery = true)
