...
public class BookingController {
	...
	@GetMapping("/draft")
	public Page<BookingDashBoardDto> findDraftBookings(
			@RequestParam String status,
			@RequestParam(defaultValue = "0") Integer pageNo,
            @RequestParam(defaultValue = "5") Integer pageSize)
	{
	//	String loggedInUser = CBSUser.getDisplayName();
		String loogedInUser = "Mitul";
		return bookingServiceImpl.getDraftBooking(status,loogedInUser, pageNo, pageSize);
	}
}
