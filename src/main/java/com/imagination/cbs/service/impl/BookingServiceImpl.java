...
import com.imagination.cbs.repository.BookingDashBoardCustomRepository;
...
public class BookingServiceImpl implements BookingService {
	...
	@Autowired
	private BookingDashBoardCustomRepository bookingCustomRepo;
	...
	{
		List<Tuple> listTuple = bookingCustomRepo.getDraftBookings(status,logInUser);
		List<BookingDashBoardDto> listDto = new ArrayList<BookingDashBoardDto>();
		...
		for(Tuple tuple:listTuple)
		{
			...
			dto.setBookingId(tuple.get("bid",Long.class));
			dto.setRoleName(tuple.get("rn", String.class));
			dto.setJobname(tuple.get("job",String.class));
			dto.setContractorName(tuple.get("name",String.class));
			dto.setContractedFromDate(tuple.get("fromDate", Timestamp.class));
			dto.setContractedToDate(tuple.get("toDate", Timestamp.class));
			dto.setChangedBy(tuple.get("changeBy",String.class)); 
			dto.setChangedDate(tuple.get("chDate", Timestamp.class));
			
			listDto.add(dto);
			
		}
		
		return new PageImpl<>(listDto, PageRequest.of(pageNo, pageSize), listDto.size());
